...
import SavedWorkout from '../../models/savedPlans.js';
...
export const createWorkoutPlan = async (req, res, next) => {
  try {
    ...
    const err = new Error('Failed to create workout plan');
    err.statusCode = 500;
    next(err);
  }
};
...
export const getPublicWorkoutPlans = async (req, res, next) => {
  try {
    ...
    const err = new Error('Failed to fetch public workouts');
    err.statusCode = 500;
    next(err);
  }
};
...
export const getPublicWorkoutPlanById = async (req, res, next) => {
  try {
    ...
    if (!workout) {
      const err = new Error('Public workout not found');
      err.statusCode = 404;
      return next(err);
    }
    ...
    const err = new Error('Failed to fetch public workout');
    err.statusCode = 500;
    next(err);
  }
};
...
export const getUserWorkoutPlans = async (req, res, next) => {
  try {
    ...
    const err = new Error('Failed to fetch user workouts');
    err.statusCode = 500;
    next(err);
  }
};
...
export const getWorkoutPlanById = async (req, res, next) => {
  try {
    ...
    const err = new Error('Failed to fetch workout');
    err.statusCode = 500;
    next(err);
  }
};
...
export const updateWorkoutPlan = async (req, res, next) => {
  try {
    ...
    if (!workout) {
      const err = new Error('Workout not found or not authorized to update');
      err.statusCode = 404;
      return next(err);
    }
    ...
    const err = new Error('Failed to update workout plan');
    err.statusCode = 500;
    next(err);
  }
};
...
export const deleteWorkoutPlan = async (req, res, next) => {
  try {
    ...
    if (!workout) {
      const err = new Error('Workout not found or not authorized to delete');
      err.statusCode = 404;
      return next(err);
    }
    ...
    const err = new Error('Failed to delete workout plan');
    err.statusCode = 500;
    next(err);
  }
};
